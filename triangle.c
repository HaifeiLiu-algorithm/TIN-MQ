...

{
	...
	printf("triangle x%I64x with orientation %d:\n", (unsigned __int64)t->tri,
		t->orient);
	...
	if (printvertex == (vertex)NULL)
		...
		printf("    Origin[%d] = x%I64x  (%.12g, %.12g)\n",
...

{
	...
	printf("subsegment x%I64x with orientation %d and mark %d:\n",
	...
	if (printvertex == (vertex)NULL)
		...
		printf("    Segment origin[%d] = x%I64x  (%.12g, %.12g)\n",
	...
	if (printvertex == (vertex)NULL)
		...
		printf("    Segment dest  [%d] = x%I64x  (%.12g, %.12g)\n",
